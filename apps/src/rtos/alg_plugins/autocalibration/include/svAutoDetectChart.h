...
static Byte svCheckPatternProfileLowDia(Byte* bwLumaFrame, Word16 posy, Word16 posx, Word16 height, Word16 width, SV_ACDetect_FPBoundaryPos* svFPBoundaryPosA, SV_ACDetect_FPBoundaryPos* svFPBoundaryPosB, double slope, Byte bScreen);
static Byte svCheckPatternProfileHiDia(Byte* bwLumaFrame, Word16 posy, Word16 posx, Word16 height, Word16 width, SV_ACDetect_FPBoundaryPos* svFPBoundaryPosA, SV_ACDetect_FPBoundaryPos* svFPBoundaryPosB, double slope, Byte bScreen);
