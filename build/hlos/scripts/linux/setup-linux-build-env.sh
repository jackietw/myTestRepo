...
cmd="sudo apt-get install ssh corkscrew gawk lib32z1 lib32ncurses5 lib32bz2-1.0 libc6:i386 libc6-i386 libstdc++6:i386 libncurses5:i386 libz1:i386 libc6-dev-i386 device-tree-compiler mono-complete"
echo "--------------------------------------------------------------------------------"
